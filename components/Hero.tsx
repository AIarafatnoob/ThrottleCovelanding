  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
      ...
      >
        ...
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all duration-300 transform hover:scale-110"><Facebook size={18} /></a>
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all duration-300 transform hover:scale-110"><Instagram size={18} /></a>
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all duration-300 transform hover:scale-110"><Youtube size={18} /></a>
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all duration-300 transform hover:scale-110">
      ...
      >
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all transform hover:scale-110"><Facebook size={20} /></a>
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all transform hover:scale-110"><Instagram size={20} /></a>
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all transform hover:scale-110"><Youtube size={20} /></a>
        <a href="#" className="text-white/40 hover:text-[#FF4438] transition-all transform hover:scale-110">
